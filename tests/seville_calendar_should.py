...
def know_workdays_in_different_years(calendar: Seville):
    assert calendar.is_working_day(date(2018, 2, 15))
    assert calendar.is_working_day(date(2023, 2, 15))


def know_feria_wednesday(calendar: Seville):
...
def return_complete_nonworking_days_for_seville(calendar: Seville):
